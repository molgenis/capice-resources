...
class TestCompareModelsExplain(unittest.TestCase):
    ...
    def test_table_merge(self):
        expected_output = pd.DataFrame(data={
            'feature': ['phyloP', 'SIFTval', 'PolyPhenVal', 'Grantham'],
            'gain_m1': [197.3686981201172, 39.576637268066406, 38.426273345947266,
                        9.386235237121582],
            'total_gain_m1': [79934.3203125, 6728.0283203125, 9068.6005859375, 1436.093994140625],
            'weight_m1': [405.0, 170.0, 236.0, 153.0],
            'cover_m1': [1705.604736328125, 958.0835571289062, 1129.3902587890625,
                         1309.001220703125],
            'total_cover_m1': [690769.9375, 162874.203125, 266536.09375, 200277.1875],
            'gain_m2': [197.3686981201172, 39.576637268066406, 38.426273345947266,
                        9.386235237121582],
            'total_gain_m2': [79934.3203125, 6728.0283203125, 9068.6005859375, 1436.093994140625],
            'weight_m2': [405.0, 170.0, 236.0, 153.0],
            'cover_m2': [1705.604736328125, 958.0835571289062, 1129.3902587890625,
                         1309.001220703125],
            'total_cover_m2': [690769.9375, 162874.203125, 266536.09375, 200277.1875]
        })
    ...
    def test_reorder_table(self):
        input_table = pd.DataFrame(data={
            ...
            'gain_m1': [197.3686981201172, 39.576637268066406, 38.426273345947266,
                        9.386235237121582],
            'gain_rank_m1': [1, 2, 3, 4],
            'total_gain_m1': [79934.3203125, 6728.0283203125, 9068.6005859375, 1436.093994140625],
            'weight_m1': [405.0, 170.0, 236.0, 153.0],
            'weight_rank_m1': [1, 3, 2, 4],
            'cover_m1': [1705.604736328125, 958.0835571289062, 1129.3902587890625,
                         1309.001220703125],
            'total_cover_m1': [690769.9375, 162874.203125, 266536.09375, 200277.1875],
            'gain_m2': [197.3686981201172, 39.576637268066406, 38.426273345947266,
                        9.386235237121582],
            'gain_rank_m2': [1, 2, 3, 4],
            'total_gain_m2': [79934.3203125, 6728.0283203125, 9068.6005859375, 1436.093994140625],
            'weight_m2': [405.0, 170.0, 236.0, 153.0],
            'weight_rank_m2': [1, 3, 2, 4],
            'cover_m2': [1705.604736328125, 958.0835571289062, 1129.3902587890625,
                         1309.001220703125],
            'total_cover_m2': [690769.9375, 162874.203125, 266536.09375, 200277.1875]
        })
