...
8. Lift over not-annotated VCFs (output from `train-data-creator`) to GRCh38 using `liftover_variants.sh` (and the Picard 3.0.0 image, available [here](https://download.molgeniscloud.org/downloads/vip/images/)):
   ```shell
